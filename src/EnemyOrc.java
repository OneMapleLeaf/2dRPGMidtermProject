...
public class EnemyOrc {
    ...
    public EnemyOrc(Tool tool, float x, float y, int width, int height) {
        this.tool = tool;
        this.x = x;
        this.y = y;
        this.width = width;
    ...
    public void SetValue() {
        try{
            Run = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Orc Crew/Orc/Run/Run-Sheet.png")));
            Idle = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Orc Crew/Orc/Idle/Idle-Sheet.png")));
            Death = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Orc Crew/Orc/Death/Death-Sheet.png")));
        }catch (Exception e){
            e.printStackTrace();
        }
