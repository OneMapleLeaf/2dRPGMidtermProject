...
public class EnemySkeleton {
    ...
    public EnemySkeleton(Tool tool, float x, float y, int width, int height) {
        this.tool = tool;
        this.x = x;
        this.y = y;
        this.width = width;
    ...
    public void SetValue() {
        try{
            Run = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Skeleton Crew/Skeleton - Rogue/Run/Run-Sheet.png")));
            Idle = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Skeleton Crew/Skeleton - Rogue/Idle/Idle-Sheet.png")));
            Death = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Skeleton Crew/Skeleton - Rogue/Death/Death-Sheet.png")));
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public void deathAnimation() {
        ...
        switch (DeathImageNum) {
            case 1 -> currentImage = Death.getSubimage( 5, 28, 32, 36);
            case 2 -> currentImage = Death.getSubimage(69, 28, 32, 36);
            case 3 -> currentImage = Death.getSubimage(133, 28, 32, 36);
            case 4 -> currentImage = Death.getSubimage(197, 28, 32, 36);
            case 5 -> currentImage = Death.getSubimage(261, 28, 32, 36);
            case 6 -> currentImage = Death.getSubimage(325, 28, 32, 36);
        }
    }
