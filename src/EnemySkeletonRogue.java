...
public class EnemySkeletonRogue {
    Tool tool;
    ...
    public EnemySkeletonRogue (Tool tool, float x, float y, int width, int height) {
        this.tool = tool;
        this.x = x;
        this.y = y;
        this.width = width;
    ...
    public void SetValue() {
        try{
            Run = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Skeleton Crew/Skeleton - Mage/Run/Run-Sheet.png")));
            Idle = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Skeleton Crew/Skeleton - Mage/Idle/Idle-Sheet.png")));
            Death = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("Pixel Crawler/Enemy/Skeleton Crew/Skeleton - Mage/Death/Death-Sheet.png")));
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public void draw(Graphics g) {
        if (isHealthZero()){
            g.drawImage(currentImage, (int) x + offset, (int) y - 48, width, height + 48, null);
            return;
        }
    ...
    public void deathAnimation() {
        ...
        switch (DeathImageNum) {
            case 1 -> currentImage = Death.getSubimage(23, 0, 35, 64);
            case 2 -> currentImage = Death.getSubimage(87, 0, 35, 64);
            case 3 -> currentImage = Death.getSubimage(151, 0, 35, 64);
            case 4 -> currentImage = Death.getSubimage(215, 0, 35, 64);
            case 5 -> currentImage = Death.getSubimage(279, 0, 35, 64);
            case 6 -> currentImage = Death.getSubimage(343, 0, 35, 64);
        }
    }
...
//    System.out.println((int) tool.GetRandomNum(1, 3));
